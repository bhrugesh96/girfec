...
<?php
  $events_cat_color = \App\get_event_cat_color( $event_id );
  $additional = [
    'event_cat_color' => $events_cat_color
  ];
?>

<div id="tribe-events-event-<?php echo esc_attr( $event_id ); ?>" class="<?php tribe_events_event_classes() ?>" data-tribejson='<?php echo esc_attr( tribe_events_template_data( $post, $additional ) ); ?>' style="color: <?= $events_cat_color; ?>">
  <h3 class="tribe-events-month-event-title" style="color: <?= $events_cat_color; ?>">
    <a href="<?php echo esc_url( $link ) ?>" class="url" style="color: <?= $events_cat_color; ?>"><?php echo $title ?></a>
  </h3>
